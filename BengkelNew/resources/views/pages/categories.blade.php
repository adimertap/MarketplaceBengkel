    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-row">
                <!--begin::Aside-->
                <div class="flex-column offcanvas-mobile w-300px w-xl-325px" id="kt_profile_aside" data-sticky-container>
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-outline-success btn-lg align-items-lg-center">Tampilkan Lebih Bnayk</button>
                        </div>
                    </div>
                </div>
                <!--end::Card-->
...
<!--end::Page Scripts-->
<!--begin::Page Scripts(used by this page)-->
                            <script src="assets/js/pages/features/miscellaneous/sticky-panels.js?v=7.0.6"></script>
                        <!--end::Page Scripts-->
@endpush
