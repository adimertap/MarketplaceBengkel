                                        ...
                                        <table class="table table-bordered table-hover dataTable" id="dataTable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width: 100px;">Kumulatif Bulanan</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>Rp. {{ number_format($item->kumulatif_bulanan,2,',','.') }}</td>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('pph21.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="small mb-1 mr-1" for="kumulatif_bulanan">Kumulatif Bulanan</label><span class="mr-4 mb-3"
                            style="color: red">*</span>
                        <input class="form-control" name="kumulatif_bulanan" type="text" id="kumulatif_bulanan"
                            placeholder="Input Besaran Kumulatif Bulanan" value="{{ old('kumulatif_bulanan') }}"
                            class="form-control @error('kumulatif_bulanan') is-invalid @enderror"></input>
                        @error('kumulatif_bulanan')<div class="text-danger small mb-1">{{ $message }}
                        </div> @enderror
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="small mb-1 mr-1" for="kumulatif_bulanan">Kumulatif Bulanan</label><span class="mr-4 mb-3"
                            style="color: red">*</span>
                        <input class="form-control" name="kumulatif_bulanan" type="text" id="kumulatif_bulanan"
                            placeholder="Input Besaran Kumulatif Bulanan" value="{{ $item->kumulatif_bulanan }}" required>
                    </div>
                    <div class="form-group">
                        <label class="small mb-1 mr-1" for="besaran_pph21">Besaran Pph21</label><span class="mr-4 mb-3"
                        style="color: red">*</span>
