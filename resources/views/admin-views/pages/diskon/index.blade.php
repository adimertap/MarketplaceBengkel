            ...
            <div class="card card-header-actions">
                <div class="card-header">List Diskon
                    <button class="btn btn-sm btn-primary" type="button" data-toggle="modal"
                        data-target="#Modaltambah">Tambah Diskon</button>
                </div>
            </div>
            <div class="card-body">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                        ...
                                                        style="width: 70px;">Kode Diskon</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                        colspan="1" aria-label="Position: activate to sort column ascending"
                                                        style="width: 150px;">Nama Diskon</th>
                                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                        colspan="1" aria-label="Position: activate to sort column ascending"
                                                        style="width: 120px;">Jumlah Diskon</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('diskon.destroy', $item->id_diskon) }}" method="POST" class="d-inline">
                @csrf
                @method('delete')
                <div class="modal-body">Apakah Anda Yakin Menghapus Data Diskon dengan Kode {{ $item->kode_diskon }} ?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Close</button>
