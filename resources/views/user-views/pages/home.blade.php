                ...
                <div class="flex-row-fluid ml-12">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-body">
                            ...
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="../banner/1.png" alt="Cari Bengkel Terdekat">
                            </div>
                            </a>
                            <a href="hhtps://sso.bengkel-kuy.com/register">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="../banner/2.png" alt="Daftarkan Bengkel">
                                </div>
                            </a>
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel"
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a href="https://sso.bengkel-kuy.com/register">
                                    <img class="d-block w-100" src="../banner/2.png" alt="First slide">
                                </a>
                            </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="row">
                            ...
                            @foreach ($item->DetailSparepart->Rating as $star)
                            @php
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="overlay">
                                            <div class="overlay-wrapper rounded bg-light text-center">
                                                ...
                                                <img src="https://inventory.bengkel-kuy.com/image/{{ $item->DetailSparepart ->Galleries_one->photo }}"
                                                    alt="" class="mh-100 h-200px mw-100 w-200px" />
                                                @endif
                                            ...
                                            <div class="overlay-layer">
                                                ...
                                                @auth
                                                <form
                                                    action="{{ route('detail-add', $item->DetailSparepart->id_detail_sparepart) }}"
                                                    method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <!--begin: Item-->
                                                    <div class="d-flex align-items-center flex-lg my-1">
                                        ...
                                        <div
                                            class="text-center mt-2 mb-md-0 mb-5 mb-md-0 mb-5 mb-0 mb-5 d-flex flex-column">
                                            <a href="{{ route('detail', $item->DetailSparepart->slug) }}"
                                                class="font-size-h5 font-weight-bolder text-dark-75 text-hover-primary">{{ $item->DetailSparepart->Sparepart->nama_sparepart }}</a>
                                            <a href="{{ route('bengkel', $item->DetailSparepart->Bengkel->slug) }}"
                                                class="font-size-sm">{{ $item ->DetailSparepart->Bengkel['nama_bengkel'] }}</a>
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="d-flex align-items-right  my-1">
                                                    <div class="d-flex flex-column text-dark-75 ">
                                                        <span class="font-weight-bolder font-size-h5"><span
                                                                class="text-dark-50  font-weight-bold">Rp.</span>{{ $item->DetailSparepart->harga_market }}</span>
                                                    </div>
                                                </div>
                                                <!--end: Item-->
