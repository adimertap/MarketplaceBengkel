    ...
    <div class="login-aside d-flex flex-column flex-row-auto">
        ...
        <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
            ...
            <a href="#" class="login-logo text-center pt-lg-25 pb-10">
                <img src="user-assets/assets/media/logos/logo-1.png" class="max-h-70px" alt="" />
            </a>
            <!--end::Aside Header-->
        ...
        <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center"
            style="background-position-y: calc(100% + 5rem); background-image: url(user-assets/assets/media/svg/illustrations/login-visual-5.svg)">
        </div>
        <!--end::Aside Bottom-->
    </div>
    <!--begin::Aside-->
